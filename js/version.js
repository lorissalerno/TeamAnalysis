...
(function() {
    ...
    const EMBEDDED_VERSION = {"version":"v1.21","date":"2026-08-21","commit":"e7730f7","description":"Fix warning file:// Unsafe attempt to load URL in console"};
    const EMBEDDED_CHANGELOG = [{"version":"v1.21","date":"2026-08-21","novita":["Fix warning file:// Unsafe attempt to load URL in console","Ottimizza popup backup: layout compatto, gerarchia chiara, primary Scarica in evidenza, microcopy breve","Personalizzato popup chiusura: download automatico Backup Completo e chiarito limite popup nativo Chrome non modificabile","Fix altezza riquadri uguale e bug Stato Aggiornamenti con fallback file://","Popup avviso backup prima di chiudere il browser: beforeunload + modal se modifiche non salvate in backup","Changelog: testi semplificati e divisi in Novità e BugFix","Impostazioni: controllo aggiornamenti automatico da GitHub","Impostazioni: cronologia novità raggruppata per versione e giorno","README che si aggiorna da solo ad ogni versione"],"bugfix":["Fix grafico a torta per origine dati Stati (0%)","Nasconde Contenuto della Torta per grafici non Sales"]},{"version":"v1.15","date":"2026-08-20","novita":["Nuova categoria Stati per import, obiettivi e statistiche","Storico modifiche con data e conservazione 30 giorni","Obiettivi Stati: calcolo efficienza con target e tolleranza","Obiettivi: metrica di influenza attivabile quando serve"],"bugfix":["Tab Obiettivi rimane selezionato dopo il reload","Titoli obiettivi più puliti senza prefissi inutili"]},{"version":"v1.14","date":"2026-08-18","novita":["Gestione Skill completa: crea, rinomina ed elimina con controllo dati","Finestre di conferma più chiare al posto dei popup del browser"],"bugfix":["Avviso se elimini uno Skill usato da un solo collaboratore"]},{"version":"v1.13","date":"2026-08-17","novita":["Dashboard: obiettivi Sales di team per ogni Skill"],"bugfix":[]}];
